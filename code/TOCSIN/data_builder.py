...
def save_data(output_file, args, data):
    ...
    data_file = output_file if output_file.endswith(".json") else f"{output_file}.raw_data.json"
...
def load_data(input_file):
    data_file = input_file if input_file.endswith(".json") else f"{input_file}.raw_data.json"
